...
Lukas Geiger  
Bernau, Deutschland  
Kontakt: lukasgeiger@googlemail.com
...
- überträgt **keine Nutzerdaten, Dokumente oder Metadaten** an externe Server
- erfordert **kein Benutzerkonto**
- enthält **keine Werbung und keine Telemetrie**
...
- **Keine** Dokumente, keine OCR-Ergebnisse, keine Nutzungsstatistiken außerhalb
  des vom Nutzer ausgewählten Speicherorts
...
Da keine personenbezogenen Daten erhoben oder übertragen werden, bestehen keine
Auskunfts-, Berichtigungs- oder Löschungsansprüche gegenüber Dritten.

Bei Fragen wenden Sie sich an: lukasgeiger@googlemail.com
...
Lukas Geiger  
Bernau, Germany  
Contact: lukasgeiger@googlemail.com
...
- transmits **no user data, documents, or metadata** to external servers
- requires **no user account**
- contains **no advertising and no telemetry**
...
- **No** documents, OCR results, or usage statistics outside the location
...
Since no personal data is collected or transmitted, there are no claims for
information, correction, or deletion against third parties.

For questions, contact: lukasgeiger@googlemail.com
