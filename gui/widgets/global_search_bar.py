...
class GlobalSearchBar(QWidget, LoggerMixin):
    ...
    def _on_text_changed(self, text: str):
        ...
        # BUGSWEEP-32 REVIEW-NOTIZ (NICHT auto-gefixt — Architektur-/Perf-Entscheidung): suggest()
        # laeuft hier UN-debounced synchron bei JEDEM Tastendruck im GUI-Thread (der Debounce-Timer
        # oben schützt nur _do_search, nicht suggest). Bei grossem Index friert das UI beim Tippen.
        # Saubere Lösung: suggest ebenfalls debouncen ODER Suche/Suggest in QThread/QtConcurrent
        # auslagern (Ergebnis via Signal) — gilt analog für _do_search() und die Import-/Save-Pfade
        # in main_window (alle synchron im GUI-Thread). Refactor über Bugsweep-Scope hinaus -> User.
